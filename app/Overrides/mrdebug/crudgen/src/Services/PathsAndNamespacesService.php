...
//        return __DIR__.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'stubs';
        return "app".DIRECTORY_SEPARATOR."Overrides".DIRECTORY_SEPARATOR."mrdebug".DIRECTORY_SEPARATOR."crudgen".DIRECTORY_SEPARATOR."src".DIRECTORY_SEPARATOR.DIRECTORY_SEPARATOR."stubs";
    }
    ...
    {
        return "app".DIRECTORY_SEPARATOR."Overrides".DIRECTORY_SEPARATOR."mrdebug".DIRECTORY_SEPARATOR."crudgen".DIRECTORY_SEPARATOR."src".DIRECTORY_SEPARATOR.DIRECTORY_SEPARATOR."stubs".DIRECTORY_SEPARATOR.'Controller.stub';
    }
